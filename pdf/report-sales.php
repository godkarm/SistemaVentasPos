<?php
	...
	if($error_fechas==""){
		...
		$pdf->Cell(150,9,("Teléfono: ".$datos_empresa['empresa_telefono']),0,0,'L');
        ...
        $pdf->MultiCell(0,9,(strtoupper("Reporte de ventas ".$fecha_inicio." a ".$fecha_final)),0,'C',false);

		$pdf->SetFillColor(23,83,201);
		$pdf->SetDrawColor(23,83,201);
		$pdf->SetTextColor(255,255,255);
		$pdf->Cell(45,8,('Ventas realizadas'),1,0,'C',true);
		$pdf->Cell(45,8,('Total en ventas'),1,0,'C',true);
		$pdf->Cell(46,8,('Costo de ventas'),1,0,'C',true);
		$pdf->Cell(45,8,('Ganancias'),1,0,'C',true);
        ...
        if($check_ventas->rowCount()>=1){
            ...
            $pdf->Cell(45,7,($ventas_totales),'LB',0,'C');
            $pdf->Cell(45,7,(MONEDA_SIMBOLO.number_format($total_ventas,MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE),'LB',0,'C');
            $pdf->Cell(46,7,(MONEDA_SIMBOLO.number_format($total_costos,MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE),'LB',0,'C');
            $pdf->Cell(45,7,(MONEDA_SIMBOLO.number_format($total_utilidades,MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE),'LRB',0,'C');
        }else{
            $pdf->Cell(181,7,("No hay datos de ventas para mostrar"),'LBR',0,'C');
        }
