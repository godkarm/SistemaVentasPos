		...
		public function enrutador($clave,$tipo,$parametro){
			$rutas=[
				...
				"movimiento_list"=>[
					...
					"nombre"=>"Movimientos realizados",
				],
				"movimiento_search"=>[
					"vista"=>"movement-search",
					"icono"=>"fas fa-search-dollar",
					"nombre"=>"Buscar movimientos",
				],
				"producto_new"=>[
					"vista"=>"product-new",
					"icono"=>"fas fa-box",
				...
				"compra_search"=>[
					"vista"=>"shop-search",
					"icono"=>"fas fa-search-dollar",
					"nombre"=>"Buscar compra",
				],
				"compra_detail"=>[
					"vista"=>"shop-detail",
					"icono"=>"fas fa-shopping-bag",
					"nombre"=>"Detalles de compra",
				],
				"kardex_general"=>[
					"vista"=>"kardex",
					"icono"=>"fas fa-pallet",
				...
				"kardex_search"=>[
					"vista"=>"kardex-search",
					"icono"=>"fas fa-search",
					"nombre"=>"Buscar kardex",
				],
				"kardex_product"=>[
					"vista"=>"kardex-product",
				...
				"venta_search_date"=>[
					...
					"icono"=>"fas fa-search-dollar",
					"nombre"=>"Buscar venta (Fecha)",
				],
				"venta_search_code"=>[
					"vista"=>"sale-search-code",
					"icono"=>"fas fa-search-dollar",
					"nombre"=>"Buscar venta (Código)",
				],
				"venta_detail"=>[
					"vista"=>"sale-detail",
					"icono"=>"fas fa-cart-plus",
