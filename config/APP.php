<?php
	...
	const SERVERURL="http://localhost/SistemaVentasPos/";


	/*----------  Nombre de la empresa o compañia  ----------*/
	const COMPANY="VENTAS NORMAL";
	...
	const PRODUCTO_UNIDAD=["Unidad","Rollo","Kilogramo","Caja","Paquete","Lata","Galon","Botella","Tira","Sobre","Bolsa","Saco","Tarjeta","Otro"];
