				...
				foreach($datos as $rows){
					$tabla.='
						<tr class="text-center" >
                            ...
                            <td>'.mainModel::enrutador("categoria_producto","btn_info",$rows['categoria_id']).'</td>
							<td>'.mainModel::enrutador("categoria_update","btn_update",mainModel::encryption($rows['categoria_id'])).'</td>
                            <td>
