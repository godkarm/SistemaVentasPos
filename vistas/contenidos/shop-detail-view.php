...
<div class="full-box page-header">
    <h3 class="text-left text-uppercase">
        <?php echo $lc->enrutador("compra_detail","encabezado",0); ?>
    </h3>
        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content FormularioAjax" action="<?php echo SERVERURL; ?>ajax/devolucionAjax.php" method="POST" data-form="save" autocomplete="off">
                ...
                <div class="modal-body">
                    <input type="hidden" name="devolucion_compra" id="devolucion_compra" value="<?php echo $datos_compra['compra_codigo']; ?>">
